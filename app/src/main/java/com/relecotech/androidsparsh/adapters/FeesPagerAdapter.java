...
/**
 * Created by ajinkya on 12/27/2016.
 */

public class FeesPagerAdapter extends FragmentStatePagerAdapter {

    private ArrayList<Fragment> mfragmentsList;
    private ArrayList<String> mfragmentsNameList;

    public FeesPagerAdapter(FragmentManager fm, ArrayList<Fragment> fragmentsList, ArrayList<String> fragmentsNameList) {
        super(fm);
