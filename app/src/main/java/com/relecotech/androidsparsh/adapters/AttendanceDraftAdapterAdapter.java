...
/**
 * Created by ajinkya on 2/9/2017.
 */

public class AttendanceDraftAdapterAdapter extends BaseAdapter {

    Context context;
    LayoutInflater inflater;
    List<AttendanceDraftListData> draftList;

    public AttendanceDraftAdapterAdapter(Context context, List<AttendanceDraftListData> draftList) {
