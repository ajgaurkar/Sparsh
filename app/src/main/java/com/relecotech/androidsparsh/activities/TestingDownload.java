...
/**
 * Created by amey on 1/18/2016.
 */
public class TestingDownload extends Activity {
    Button button;
...
//        setContentView(R.layout.testingdownload);
//        button = (Button) findViewById(R.id.button2);
        ...
        directory = "/storage/emulated/0/schoolonline_data/";
