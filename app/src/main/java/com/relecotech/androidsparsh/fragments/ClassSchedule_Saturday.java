...
public class ClassSchedule_Saturday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        slotWiseMap = Class_ScheduleFragment.studentTimeTableHashMap.get("Saturday");
        System.out.println("slotWiseMap----------------------------------------************************** " + slotWiseMap);
        ...
        if (slotWiseMap != null) {
            ...
            if (userRole.equals("Teacher")) {
                ...
                try {
                    ...
                    System.out.println("Saturday First Key___________" + key);
