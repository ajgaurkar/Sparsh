...
//        noDataAvailableTextView = (TextView) rootView.findViewById(R.id.no_data_available_text_view);
        ...
        slotWiseMap = Class_ScheduleFragment.studentTimeTableHashMap.get("Tuesday");
        System.out.println("slotWiseMap  Tuesday " + slotWiseMap);
            ...
            if (userRole.equals("Teacher")) {
                ...
                try {
                    ...
                    for (Map.Entry<Integer, StudentTimeTableListData> entrys : slotWiseMap.entrySet()) {
                        ...
                        System.out.println("Data to be send to date difference method is " + start_time + "" +
                                "::" + prev_endTime);
